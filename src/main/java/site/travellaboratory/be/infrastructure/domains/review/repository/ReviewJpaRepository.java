...
public interface ReviewJpaRepository extends JpaRepository<ReviewJpaEntity, Long> {
    ...
    Optional<ReviewJpaEntity> findByArticleJpaEntityAndStatusInOrderByArticleJpaEntityDesc(
    ...
    Optional<ReviewJpaEntity> findByArticleJpaEntityAndStatus(ArticleJpaEntity articleJpaEntity, ReviewStatus status);
