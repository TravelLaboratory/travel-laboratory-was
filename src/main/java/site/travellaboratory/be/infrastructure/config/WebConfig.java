...
import site.travellaboratory.be.infrastructure.domains.auth.jwt.interceptor.AuthorizationInterceptor;
import site.travellaboratory.be.presentation.auth.resolver.AuthenticatedUserIdResolver;
